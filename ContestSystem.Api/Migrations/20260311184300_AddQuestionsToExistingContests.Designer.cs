...
namespace ContestSystem.Api.Migrations
{
    ...
    [Migration("20260311184300_AddQuestionsToExistingContests")]
    partial class AddQuestionsToExistingContests
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ContestSystem.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$06OhodCXstXd8Gs.dhUusuPfbe/E1y417u7rMSP5ozN2tsXkbFJ1a",
                            Role = "3",
                            Username = "SuperAdmin"
                        });
                });
